...
*   **Target Files:**
    *   `01_research/sources/source_registry.md`
    *   `01_research/notes/research_backlog.md`
*   **Key Responsibilities:**
    ...
    *   Manage the `research_backlog.md` by suggesting research steps to close unverified gaps.
