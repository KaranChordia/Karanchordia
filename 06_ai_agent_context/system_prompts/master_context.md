...
3.  **File Referencing**: Always use clickable local file links with the `file:///` scheme (e.g., [career_timeline.md](file:///Users/k.c/KC-HDT-AIS/02_founder_context/timeline/career_timeline.md)) to maintain easy navigation.
